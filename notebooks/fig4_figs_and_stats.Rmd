...
error_decay_rates <- read_csv(
  "../data/processed/exp_fits_errors_df.csv",
  col_types = cols(
    .default = col_double(),
    ppid = col_factor(),
    experiment = col_factor(),
...
error_decay_rates_3par <- read_csv(
...
fitted_errors_df <- read_csv(
  "../data/processed/fit_curves/fitted_exp_fits_errors_df.csv",
  col_types = cols(
    .default = col_double(),
    experiment = col_factor(),
    phase = col_factor()
...
data_per_ppt <- omnibus_df %>%
  filter(
    ...
    trial_num >= 214,
    phase == "training", learning_and_decay_curves == 1
  ) %>%
  mutate(
    trial_num = ifelse(
      trial_num >= 335,
...
p <- data_per_group %>%
  ...
  geom_hline(
    yintercept = c(.20, .40), linewidth = 0.4,
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_initial_exps_error.pdf", device = "pdf",
    height = 2, width = 2.5
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_initial_exps_error_fitted_only.pdf", device = "pdf",
...
## Error Decay Rates
```{r, fig.width=10, fig.height=6, out.width="100%"}
data_per_ppt <- error_decay_rates %>%
  filter(
    experiment %in% c(
      "accel_uncued", "accel_cued_tilt",
      "rot30_uncued", "rot30_cued_tilt"
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot30_error_decay_rates.pdf", device = "pdf",
...
## Error Decay High Points (Starts)
```{r, fig.width=10, fig.height=6, out.width="100%"}
p <- data_per_group %>%
  ggplot(
  ...
  # add horizontal lines
  geom_hline(
    yintercept = c(0, .2, .4, .6), linewidth = 0.4,
    colour = "#CCCCCC", linetype = "solid"
  ) +
  geom_hline(
    yintercept = c(.1, .3, .5), linewidth = 0.4,
    colour = "#CCCCCC", linetype = "dashed"
  ) +
  # y-axis scale
  scale_y_continuous(
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot30_error_start_points.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_exps.pdf", device = "pdf",
    height = 2, width = 2.5
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_exps_fitted_only.pdf", device = "pdf",
    height = 2, width = curve_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_error_decay_rates.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_error_start_points.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_training.pdf", device = "pdf",
    height = 2, width = 2.5
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_training_fitted_only.pdf", device = "pdf",
    height = 2, width = curve_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_training_learning_rates.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_training_asymptotes.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_normalized_washout.pdf", device = "pdf",
    height = 2, width = 2.5
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_washout_learning_rates.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_washout_starts.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_alt_washout.pdf", device = "pdf",
    height = 2, width = 2.5
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_alt_washout_fitted_only.pdf", device = "pdf",
    height = 2, width = curve_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_alt_washout_learning_rates.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_alt_washout_starts.pdf", device = "pdf",
    height = 2, width = per_group_fig_width
  )
}
