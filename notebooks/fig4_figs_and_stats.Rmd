...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_initial_exps_phases.pdf", device = "pdf",
    height = 2, width = 2.5
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_exps_phases.pdf", device = "pdf",
    height = 2, width = 2.5
  )
}
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig4_rot15_normalized_training.pdf", device = "pdf",
    height = 2, width = 2.5
  )
}
