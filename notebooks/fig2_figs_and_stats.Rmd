...
# fitted curves
p <- p + geom_line(data = filter(fitted_learning_rate_df,
                             experiment %in% c(
                               "accel_uncued", "accel_cued_tilt",
                               "rot30_uncued", "rot30_cued_tilt"
                               ), 
...
if (save_plots) {
  ggsave(
    p,
    filename = "../data/figs/paper_figs/fig2_initial_exps_normalized_alt_washout.pdf", device = "pdf",
    height = 2, width = curve_fig_width
  )
}
